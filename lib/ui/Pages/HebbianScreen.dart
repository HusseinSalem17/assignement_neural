...
class HebbianPage extends StatefulWidget {
  const HebbianPage({Key? key}) : super(key: key);

  @override
  State<HebbianPage> createState() => _HebbianPageState();
}

class _HebbianPageState extends State<HebbianPage> {
  File? img1, img2, img3;
